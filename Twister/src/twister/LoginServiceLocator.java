...
public class LoginServiceLocator extends org.apache.axis.client.Service implements twister.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/TwisterServer/services/Login";
    ...
    public twister.Login getLogin() throws javax.xml.rpc.ServiceException {
    ...
    public twister.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            twister.LoginSoapBindingStub _stub = new twister.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (twister.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                twister.LoginSoapBindingStub _stub = new twister.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://twister", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://twister", "Login"));
        }
